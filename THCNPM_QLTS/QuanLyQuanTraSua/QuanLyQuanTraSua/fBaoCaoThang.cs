...
namespace QuanLyQuanTraSua
{
    public partial class fBaoCaoThang : Form
    {
        ...
        private void TxtbMonth_SelectedValueChanged(object sender, EventArgs e)
        {
        ...
        private void Button1_Click(object sender, EventArgs e)
        {
            ...
            if (txtbYear.Text != "" && txtbMonth.Text!="Chọn tháng")
            {
                int month = int.Parse(txtbMonth.Text);
                ...
                DataTable x = DataProvider.Instance.ExcuteQuery("SELECT ID FROM HOADON WHERE DATEDIFF(MONTH,NgayDat,'" + date + "')=0");
                int[] res = new int[100];
                int dem = 0;
                ...
                DataTable data = DataProvider.Instance.ExcuteQuery("SELECT * FROM HOADON WHERE DATEDIFF(MONTH,NgayDat,'" + date + "')=0");
                int S = 0;
